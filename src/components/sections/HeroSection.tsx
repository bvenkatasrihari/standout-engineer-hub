      ...
      <div className="container max-w-6xl mx-auto px-4 py-32">
        <div className="flex flex-col items-center text-center">
          ...
          ease: 'easeOut'
            ...
            <motion.a href="https://linkedin.com/in/venkatasrihariboyi" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-secondary/50 border border-border/50 text-muted-foreground hover:text-foreground hover:border-primary/50 hover:bg-secondary transition-all duration-300" aria-label="LinkedIn" whileHover={{
            scale: 1.1
          }} whileTap={{
            scale: 0.95
          }}>
