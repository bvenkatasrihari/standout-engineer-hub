...
const experiences = [{
  ...
  achievements: ['Acquired hands-on ML & AI implementation experience', 'Achieved 95% usability across devices through cross-browser testing', 'Collaborated using Agile methodologies for on-time delivery']
}, {
  type: 'work',
  ...
  achievements: ['Enhanced skills in database management and user authentication', 'Developed full-stack web applications', 'Integrated frontend technologies with Django backend']
}, {
  type: 'education',
  ...
  achievements: ['Specialization in Computer Science and Engineering', 'Project work in ML-based security systems']
}];
